...
function Perks({onChanged,selected}) {
    ...
    const cbHandler=(e)=>{
        ...
        if(e.target.checked){
           return onChanged([...selected,e.target.name])
            ...
            onChanged([...selected.filter((selected)=>selected!==e.target.name)])
        }
    }
    const Perkzcomponent=(name,icon,named,cbHandler,onchange)=>{
        return(
        <>
  ...
  return (
    <div>
            ...
            <h3 className='text-sm'>Select all the perks of your place</h3>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2'>
                {Perkzcomponent(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                {Perkzcomponent(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    ,'Free parking spot','parking',cbHandler)}
                {Perkzcomponent(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                {Perkzcomponent(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    ,'Private entrace','private',cbHandler)}
            </div>
    </div>
  )
}
